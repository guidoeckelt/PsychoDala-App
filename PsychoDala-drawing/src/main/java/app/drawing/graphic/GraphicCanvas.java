...
import app.drawing.render.impl.FillRectTask;
import app.drawing.render.impl.SetFillTask;
...
public class GraphicCanvas {
    ...
    private LinkedList<RenderTask> renderTasks;
    ...
    public List<RenderTask> getRenderTasks() {
        return renderTasks;
    }

    public boolean isUsed() {
        return this.renderTasks.size() > 0;
    }

    private void addGraphicTask(RenderTask renderTask) {
